// Package syntaxis provides Operational Transformation (OT) algorithms
// for real-time collaborative editing.
//
// Syntaxis (σύνταξις) means "coordination" or "ordering" in Greek,
...
// # Overview
//
// The syntaxis package implements the core OT operations including:
...
//	op3 := syntaxis.NewInsert(5, " World")
//
//	// Compose operations
//	composed := syntaxis.Compose(op1, op2, op3)
//
//	// Transform operations against each other
//	transformed1, transformed2 := syntaxis.Transform(op1, op2)
//
// # Thread Safety
//
...
//
//	op := syntaxis.Compose(
//	    syntaxis.NewInsert(0, "Hello"),
//	    syntaxis.NewRetain(5),
//	    syntaxis.NewInsert(5, " World"),
//	)
...
//
//	op1 := syntaxis.NewInsert(0, "Hello")
//	op2 := syntaxis.NewInsert(0, "Hi")
//	newOp1, newOp2 := syntaxis.Transform(op1, op2)
